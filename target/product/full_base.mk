...
PRODUCT_PROPERTY_OVERRIDES := \
    ...
    ro.config.notification_sound=null
else
PRODUCT_PROPERTY_OVERRIDES := \
    ro.config.ringtone=Ring_Synth_04.ogg \
...
# MIUI MOD: START
# set default locale for recovery
# PRODUCT_LOCALES := en_US
ifneq (,$(filter $(MIUI_BUILD_SUPPORT_REGION), cn tw hk))
PRODUCT_LOCALES := zh_CN
else ifneq (,$(filter $(MIUI_BUILD_SUPPORT_REGION), jp))
