...
ifeq ($(TARGET_PRODUCT), $(filter $(TARGET_PRODUCT), munch alioth thyme enuma elish psyche))
...
$(KERNEL_HEADERS_INSTALL): $(KERNEL_OUT) $(DTC) $(UFDT_APPLY_OVERLAY)
	...
	KERNEL_CONFIG_OVERRIDE_DEBUGFS=$(KERNEL_CONFIG_OVERRIDE_DEBUGFS) \
	KERNEL_CONFIG_OVERRIDE_MSM_TZ_LOG=$(KERNEL_CONFIG_OVERRIDE_MSM_TZ_LOG) \
	KERNEL_CONFIG_OVERRIDE_QMP_DEBUGFS_CLIENT=$(KERNEL_CONFIG_OVERRIDE_QMP_DEBUGFS_CLIENT) \
	KERNEL_CONFIG_OVERRIDE_REGMAP_ALLOW_WRITE_DEBUGFS=$(KERNEL_CONFIG_OVERRIDE_REGMAP_ALLOW_WRITE_DEBUGFS) \
	TZ=$(TZ) \
...
link_ext:
	...
	if [ -f "$(abspath miui/kernel/memory/rtmm/include/linux/rtmm.h)" ]; then \
		...
		ln -s -f $(abspath miui/kernel/trace/ktrace/include/linux/ktrace.h) $(TARGET_KERNEL_SOURCE)/include/linux/ktrace.h; \
	fi
