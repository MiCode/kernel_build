...
def ProcessTargetFiles(input_tf_zip, output_tf_zip, misc_info,
  ...
  for info in input_tf_zip.infolist():
    ...
    # System properties.
        ...
        "ODM/etc/build_sunstone_cn.prop",
        "ODM/etc/build_sunstone_in.prop",
        "ODM/etc/build_sunstone_global.prop",

        "VENDOR/build_sunstone_cn.prop",
        "VENDOR/build_sunstone_in.prop",
        "VENDOR/build_sunstone_global.prop",

        "ODM/etc/build_moonstone_p_cn.prop",
        "ODM/etc/build_moonstone_p_in.prop",
        "ODM/etc/build_moonstone_p_global.prop",

        "VENDOR/build_moonstone_p_cn.prop",
        "VENDOR/build_moonstone_p_in.prop",
        "VENDOR/build_moonstone_p_global.prop",
