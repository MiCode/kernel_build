...
def CreateImage(input_dir, info_dict, what, output_file, block_list=None):
  ...
  with_erofs = info_dict.get("%s_fs_type" % (what)) == "erofs"
  if with_erofs:
    # erofs filesystem don't support getting file block map at presenti
    print("Building %s image with erofs filesystem" % (what))
    block_list=None
