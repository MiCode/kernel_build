...
TARGET_MERGE_OUT_ROOT := $(TARGET_PRODUCT_OUT_ROOT)/merge
.KATI_READONLY := TARGET_OUT_ROOT TARGET_PRODUCT_OUT_ROOT PRODUCT_OUT  TARGET_MERGE_OUT_ROOT
...
TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_APP := $(TARGET_OUT_PRODUCT)/pangu/system/app
TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_PRIV_APP := $(TARGET_OUT_PRODUCT)/pangu/system/priv-app
TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_FRAMEWORK := $(TARGET_OUT_PRODUCT)/pangu/system/framework
TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_ETC_PER := $(TARGET_OUT_PRODUCT)/pangu/system/etc/permissions
.KATI_READONLY := \
  ...
  TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_APP \
  TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_PRIV_APP \
  TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_FRAMEWORK \
  TARGET_OUT_PRODUCT_OVERLAY_SYSTEM_ETC_PER \
